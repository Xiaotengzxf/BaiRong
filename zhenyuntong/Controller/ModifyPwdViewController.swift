...
class ModifyPwdViewController: UIViewController , UITextFieldDelegate {
    ...
    @IBAction func saveNewPwd(_ sender: Any) {
        ...
        NetworkManager.installshared.request(type: .post, url: NetworkManager.installshared.null, params: ["userId" : userId , "newPassword" : DESHelper.encryptUseDES(password)]){
